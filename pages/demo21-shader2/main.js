...
let demo = {
    ...
    initObject() {
        ...
        const vShader = document.getElementById('vs').textContent
        const fShader = document.getElementById('fs').textContent
        const boxGeom = new THREE.BoxGeometry(100, 100, 100)
        const boxMatrial = new THREE.ShaderMaterial({
        ...
        Object.assign(window, {boxMatrial})
    },
    initTween() {
