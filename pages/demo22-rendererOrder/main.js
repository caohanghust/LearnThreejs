...
let demo = {
    ...
    initObject() {
        ...
        let boxGeom1 = new THREE.BoxGeometry(50, 50, 50)
        const boxMatrial1 = new THREE.MeshBasicMaterial({
          color: 0x00ff00,
          transparent: true,
          depthTest: 2,
          opacity: 1
        })
        const box1 = new THREE.Mesh(boxGeom1, boxMatrial1)
        box1.position.set(100 , 100, 100)
        // box1.material.color = 0x00ff00
        box1.renderOrder = 2
        this.scene.add(box1)
        setTimeout(() => {
